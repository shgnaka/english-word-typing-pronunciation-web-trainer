...
function resolveTheme(preference: ThemePreference): ResolvedTheme {
  ...
  return {
    ...
    cssVariables: {
      ...
      "--theme-secondary-fill-alpha": formatAlpha(1),
      "--theme-secondary-hover-alpha": formatAlpha(1),
      "--theme-panel-border-alpha": formatAlpha(1),
      "--theme-input-border-alpha": formatAlpha(1),
      "--theme-panel-shadow-alpha": formatAlpha(0),
      "--theme-accent-shadow-alpha": formatAlpha(0),
      "--theme-accent-soft-alpha": formatAlpha(1),
      "--theme-accent-outline-alpha": formatAlpha(1),
      ...
      "--color-panel-border-soft": toCssRgb(mixRgb(primaryText, surfaceStrong, isDark ? 0.72 : 0.64)),
      ...
      "--color-accent-shadow": toCssRgb(accentBase),
      "--color-accent-outline": toCssRgb(accentBase),
      "--color-accent-outline-soft": toCssRgb(mixRgb(accentBase, surfaceStrong, isDark ? 0.3 : 0.22)),
      ...
      "--color-danger-shadow": toCssRgb(dangerBase),
      "--color-danger-banner-bg": toCssRgb(mixRgb(dangerBase, surfaceStrong, isDark ? 0.84 : 0.88)),
      "--color-danger-banner-border": toCssRgb(mixRgb(dangerBase, surfaceStrong, isDark ? 0.18 : 0.12)),
      ...
      "--color-finger-shadow-base": toCssRgb(preset.neutral.canvas),
      "--color-secondary-fill": toCssRgb(raised),
      "--color-secondary-fill-strong": toCssRgb(mixRgb(raised, accentBase, 0.12)),
      "--color-input-border": toCssRgb(mixRgb(primaryText, surfaceStrong, isDark ? 0.7 : 0.54)),
      "--color-panel-shadow": toCssRgb({ r: 0, g: 0, b: 0 }),
      ...
      "--color-border-strong": toCssRgb(mixRgb(primaryText, surfaceStrong, isDark ? 0.58 : 0.5)),
      "--color-border-contrast": toCssRgb(mixRgb(primaryText, surfaceStrong, isDark ? 0.44 : 0.36)),
      ...
      "--color-status-success-bg": toCssRgb(mixRgb(successBase, surfaceStrong, isDark ? 0.82 : 0.88)),
      "--color-status-success-border": toCssRgb(mixRgb(successBase, surfaceStrong, isDark ? 0.22 : 0.14)),
      "--color-status-success-text": toCssRgb(primaryText),
      "--color-status-warning-bg": toCssRgb(mixRgb(warningBase, surfaceStrong, isDark ? 0.82 : 0.88)),
      "--color-status-warning-border": toCssRgb(mixRgb(warningBase, surfaceStrong, isDark ? 0.22 : 0.16)),
      "--color-status-warning-text": toCssRgb(primaryText),
      "--color-status-error-bg": toCssRgb(mixRgb(dangerBase, surfaceStrong, isDark ? 0.84 : 0.9)),
      "--color-status-error-border": toCssRgb(mixRgb(dangerBase, surfaceStrong, isDark ? 0.24 : 0.16)),
      "--color-status-error-text": toCssRgb(primaryText),
      "--color-status-info-bg": toCssRgb(mixRgb(infoBase, surfaceStrong, isDark ? 0.84 : 0.9)),
      "--color-status-info-border": toCssRgb(mixRgb(infoBase, surfaceStrong, isDark ? 0.22 : 0.14)),
      "--color-status-info-text": toCssRgb(primaryText),
      "--color-success-chip-bg": toCssRgb(mixRgb(successBase, surfaceStrong, isDark ? 0.86 : 0.92)),
      "--color-success-chip-border": toCssRgb(mixRgb(successBase, surfaceStrong, isDark ? 0.2 : 0.12)),
      "--color-success-chip-text": toCssRgb(primaryText),
      "--color-warning-chip-bg": toCssRgb(mixRgb(warningBase, surfaceStrong, isDark ? 0.86 : 0.92)),
      "--color-warning-chip-border": toCssRgb(mixRgb(warningBase, surfaceStrong, isDark ? 0.2 : 0.12)),
      "--color-warning-chip-text": toCssRgb(primaryText),
      "--color-neutral-chip-bg": toCssRgb(muted),
      "--color-neutral-chip-border": toCssRgb(mixRgb(primaryText, surfaceStrong, 0.74)),
