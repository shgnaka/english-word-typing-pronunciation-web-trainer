      ...
      <div className="theme-settings-top">
        ...
        <div className="theme-preview-card" data-testid="theme-preview-card">
          ...
          <div className="theme-preview-body">
            <span className="theme-preview-pill">{t(language, "settings.themePreviewAccent")}</span>
            <span className="theme-preview-surface">{t(language, "settings.themePreviewSurface")}</span>
          </div>
        </div>
      </div>

      <div className="theme-settings-stack">
