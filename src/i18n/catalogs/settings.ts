...
export const settingsMessages = defineMessages({
  en: {
    ...
    "settings.wordReading": "Show word reading",
    "settings.theme": "Theme",
    "settings.themeHelp": "Pick a base mood, then fine-tune the accent and background strength.",
    "settings.themeAccent": "Accent color",
    "settings.themeBackgroundIntensity": "Background intensity",
    "settings.themePreview": "Live preview",
    "settings.themePreviewTitle": "Practice panel mood",
    "settings.themePreviewAccent": "Accent button",
    "settings.themePreviewSurface": "Panel surface",
    "settings.themeReset": "Reset theme",
    "settings.profileGroup": "Profiles",
    "settings.profileHelp": "Profiles stay in this browser only.",
    "settings.profileActive": "Current",
    "settings.profileCurrent": "Current profile",
    "settings.profileName": "Profile name",
    "settings.profileUpdatedAt": "Last updated",
    "settings.profileCreate": "Create profile",
    "settings.profileRename": "Save name",
    "settings.profileDelete": "Delete profile",
    "settings.profileDeleteConfirm": "Delete {name} from this browser? This cannot be undone.",
    "settings.profileDeleteDisabled": "At least one profile must remain.",
    "settings.profileSwitch": "Switch profile",
    "settings.themePresetDusk": "Dusk",
    "settings.themePresetForest": "Forest",
    "settings.themePresetOcean": "Ocean",
    "settings.themePresetDawn": "Dawn",
    "settings.themePresetDaylight": "Daylight",
    "settings.themeAccentAmber": "Amber",
    "settings.themeAccentMint": "Mint",
    "settings.themeAccentSky": "Sky",
    "settings.themeAccentRose": "Rose",
  ...
  ja: {
    ...
    "settings.theme": "テーマ",
    "settings.themeHelp": "ベーステーマを選んでから、アクセント色と背景の強さを微調整できます。",
    "settings.themeAccent": "アクセントカラー",
    "settings.themeBackgroundIntensity": "背景の強さ",
    "settings.themePreview": "ライブプレビュー",
    "settings.themePreviewTitle": "練習画面の見た目",
    "settings.themePreviewAccent": "アクセントボタン",
    "settings.themePreviewSurface": "パネルの質感",
    "settings.themeReset": "テーマをリセット",
    "settings.profileGroup": "プロフィール",
    "settings.profileHelp": "プロフィールはこのブラウザ内にのみ保存されます。",
    "settings.profileActive": "現在",
    "settings.profileCurrent": "現在のプロフィール",
    "settings.profileName": "プロフィール名",
    "settings.profileUpdatedAt": "最終更新日",
    "settings.profileCreate": "プロフィールを追加",
    "settings.profileRename": "名前を保存",
    "settings.profileDelete": "プロフィールを削除",
    "settings.profileDeleteConfirm": "このブラウザから {name} を削除しますか？ この操作は元に戻せません。",
    "settings.profileDeleteDisabled": "少なくとも 1 つのプロフィールが必要です。",
    "settings.profileSwitch": "プロフィールを切り替え",
    "settings.themePresetDusk": "ダスク",
    "settings.themePresetForest": "フォレスト",
    "settings.themePresetOcean": "オーシャン",
    "settings.themePresetDawn": "ドーン",
    "settings.themePresetDaylight": "デイライト",
    "settings.themeAccentAmber": "アンバー",
    "settings.themeAccentMint": "ミント",
    "settings.themeAccentSky": "スカイ",
    "settings.themeAccentRose": "ローズ",
  ...
  "ja-hira": {
    ...
    "settings.theme": "テーマ",
    "settings.themeHelp": "ベーステーマを えらんでから、アクセントいろと はいけいの つよさを ちょうせいできます。",
    "settings.themeAccent": "アクセントカラー",
    "settings.themeBackgroundIntensity": "はいけいの つよさ",
    "settings.themePreview": "ライブプレビュー",
    "settings.themePreviewTitle": "れんしゅうがめんの みため",
    "settings.themePreviewAccent": "アクセントボタン",
    "settings.themePreviewSurface": "パネルの しつかん",
    "settings.themeReset": "テーマを リセット",
    "settings.profileGroup": "プロフィール",
    "settings.profileHelp": "プロフィールは このブラウザないに のみ ほぞんされます。",
    "settings.profileActive": "いま",
    "settings.profileCurrent": "いまの プロフィール",
    "settings.profileName": "プロフィールなまえ",
    "settings.profileUpdatedAt": "さいしゅうこうしんび",
    "settings.profileCreate": "プロフィールを ついか",
    "settings.profileRename": "なまえを ほぞん",
    "settings.profileDelete": "プロフィールを さくじょ",
    "settings.profileDeleteConfirm": "このブラウザから {name} を さくじょしますか？ このそうさは もとに もどせません。",
    "settings.profileDeleteDisabled": "すくなくとも 1つの プロフィールが ひつようです。",
    "settings.profileSwitch": "プロフィールを きりかえ",
    "settings.themePresetDusk": "ダスク",
    "settings.themePresetForest": "フォレスト",
    "settings.themePresetOcean": "オーシャン",
    "settings.themePresetDawn": "ドーン",
